...
/datum/antagonist/space_dragon/proc/victory()
	...
	priority_announce("A large amount of lifeforms have been detected approaching [station_name()] at extreme speeds. \
		...
		text_ru = "Зафиксировано приближение большого числа форм жизни к [station_name()] на экстремальной скорости. Оставшемуся экипажу рекомендуется немедленно эвакуироваться.",
