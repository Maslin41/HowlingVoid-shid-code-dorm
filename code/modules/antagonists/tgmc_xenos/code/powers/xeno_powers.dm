...
/datum/action/cooldown/alien/tgmc/literally_too_angry_to_die/Activate()
	...
	playsound(owner, 'code/modules/antagonists/tgmc_xenos/sound/alien_roar1.ogg', 100, TRUE, 8, 0.9)
...
/datum/action/cooldown/alien/tgmc/evade/Activate()
	...
	playsound(owner, 'code/modules/antagonists/tgmc_xenos/sound/alien_hiss.ogg', 100, TRUE, 8, 0.9)
