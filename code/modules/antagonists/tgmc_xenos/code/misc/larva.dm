...
/datum/action/cooldown/alien/larva_evolve/tgmc/Activate(atom/target)
	...
	if(!caste_options)
		...
		make_xeno_caste_entry(
			caste_name = "Runner",
			caste_image = image(icon = 'code/modules/antagonists/tgmc_xenos/icons/xeno_actions.dmi', icon_state = "preview_runner"),
		...
		make_xeno_caste_entry(
			caste_name = "Sentinel",
			caste_image = image(icon = 'code/modules/antagonists/tgmc_xenos/icons/xeno_actions.dmi', icon_state = "preview_sentinel"),
			caste_info = span_info( \
		...
		make_xeno_caste_entry(
			caste_name = "Defender",
			caste_image  = image(icon = 'code/modules/antagonists/tgmc_xenos/icons/xeno_actions.dmi', icon_state = "preview_defender"),
			caste_info = span_info( \
		...
		make_xeno_caste_entry(
			caste_name = "Drone",
			caste_image  = image(icon = 'code/modules/antagonists/tgmc_xenos/icons/xeno_actions.dmi', icon_state = "preview_drone"),
			caste_info = span_info( \
