/obj/item/stake
	...
	icon = 'code/modules/antagonists/vampire/icons/stakes.dmi'
	icon_state = "wood"
	inhand_icon_state = "wood"
	lefthand_file = 'code/modules/antagonists/vampire/icons/bs_leftinhand.dmi'
	righthand_file = 'code/modules/antagonists/vampire/icons/bs_rightinhand.dmi'
...
/obj/item/stake/attack(mob/living/target, mob/living/user, params)
	...
	if(!force_embed(target, BODY_ZONE_CHEST))
		return
