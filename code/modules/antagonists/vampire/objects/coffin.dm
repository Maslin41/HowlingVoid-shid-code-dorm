...
/obj/structure/closet/crate/coffin/can_open(mob/living/user, force)
	...
	if(user.mind == resident)
		...
		locked = FALSE
		return TRUE
	playsound(get_turf(src), 'code/modules/antagonists/vampire/sound/door_locked.ogg', vol = 20, vary = TRUE)
...
/obj/structure/closet/crate/coffin/blackcoffin
	...
	icon_state = "coffin"
	base_icon_state = "coffin"
	icon = 'code/modules/antagonists/vampire/icons/vamp_obj.dmi'
	open_sound = 'code/modules/antagonists/vampire/sound/coffin_open.ogg'
	close_sound = 'code/modules/antagonists/vampire/sound/coffin_close.ogg'
