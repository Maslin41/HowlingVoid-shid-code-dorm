...
/obj/effect/decal/cleanable/blood/particle/proc/on_bounce()
	...
	if(blood_dna)
		for(var/dna_sample in blood_dna)
			...
			if(istype(blood, /datum/blood_type/xeno))
				is_xenoblood = TRUE
				break
...
/obj/effect/decal/cleanable/blood/splatter/stacking/Initialize(mapload, blood_color = LIGHT_COLOR_BLOOD_MAGIC)
	color = blood_color
	. = ..()
...
/obj/effect/decal/cleanable/blood/line
	...
	icon = 'code/modules/antagonists/vampire/icons/blood.dmi'
	icon_state = "line"
