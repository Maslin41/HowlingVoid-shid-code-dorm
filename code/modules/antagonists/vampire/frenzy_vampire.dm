...
/atom/movable/screen/alert/status_effect/frenzy
	...
	icon = 'code/modules/antagonists/vampire/icons/actions_vampire.dmi'
...
/datum/status_effect/frenzy/on_apply()
	...
	carbon_owner.playsound_local(null, 'code/modules/antagonists/vampire/sound/rage_increase.ogg', 100, FALSE, pressure_affected = FALSE)
...
/datum/status_effect/frenzy/on_remove()
	...
	carbon_owner.playsound_local(null, 'code/modules/antagonists/vampire/sound/rage_decrease.ogg', 100, FALSE, pressure_affected = FALSE)
