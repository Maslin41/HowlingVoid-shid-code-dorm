/obj/item/melee/blood_magic/stun/proc/effect_vampire(mob/living/target, mob/living/carbon/user)
	...
	playsound(user, 'code/modules/antagonists/vampire/sound/rage_increase.ogg', vol = 100, vary = FALSE, pressure_affected = FALSE)
...
/obj/effect/temp_visual/sanguine_boom
	icon = 'code/modules/antagonists/vampire/icons/64x64.dmi'
