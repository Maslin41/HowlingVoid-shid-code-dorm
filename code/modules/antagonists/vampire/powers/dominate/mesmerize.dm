...
/datum/action/cooldown/vampire/targeted/mesmerize
	...
	level_current = 1
	ranged_mousepointer = 'code/modules/antagonists/vampire/icons/vampire_mesmerize.dmi'
...
/datum/status_effect/mesmerized/on_apply()
	...
	owner.playsound_local(null, 'code/modules/antagonists/vampire/sound/mesmerize.ogg', 100, FALSE, pressure_affected = FALSE)
	return TRUE
