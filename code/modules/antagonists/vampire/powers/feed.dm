...
/datum/action/cooldown/vampire/targeted/feed
	...
	ranged_mousepointer = 'code/modules/antagonists/vampire/icons/vampire_feed.dmi'
...
/datum/action/cooldown/vampire/targeted/feed/fire_targeted_power(atom/target_atom, list/modifiers)
	...
	if(living_owner.pulling == feed_target && !living_owner.grab_state >= GRAB_AGGRESSIVE)
		...
		feed_target.playsound_local(null, 'code/modules/antagonists/vampire/sound/mesmerize.ogg', 100, FALSE, pressure_affected = FALSE)
		...
		living_owner.playsound_local(null, 'code/modules/antagonists/vampire/sound/drinkblood1.ogg', 100, FALSE, pressure_affected = FALSE)
		...
		playsound(living_owner, 'code/modules/antagonists/vampire/sound/drinkblood1.ogg', 50)
