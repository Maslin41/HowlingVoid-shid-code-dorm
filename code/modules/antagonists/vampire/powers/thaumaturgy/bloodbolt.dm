/datum/action/cooldown/vampire/targeted/bloodbolt
	...
	ranged_mousepointer = 'code/modules/antagonists/vampire/icons/vampire_bloodbolt.dmi'
...
/datum/action/cooldown/vampire/targeted/bloodbolt/fire_targeted_power(atom/target_atom, list/modifiers)
	...
	playsound(living_owner, 'code/modules/antagonists/vampire/sound/bloodbolt_fire.ogg', 60, TRUE)
...
/obj/projectile/magic/arcane_barrage/vampire
	...
	damage = 50
	hitsound = 'code/modules/antagonists/vampire/sound/bloodbolt.ogg'
...
/obj/projectile/magic/arcane_barrage/vampire/on_hit(atom/target, blocked = 0, pierce_hit)
	...
	if(isliving(target))
		...
		living_target.blood_particles(5, angle = rand(0, 360), min_deviation = -180, max_deviation = 180)
