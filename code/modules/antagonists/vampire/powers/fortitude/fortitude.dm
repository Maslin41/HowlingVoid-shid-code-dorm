...
/datum/action/cooldown/vampire/fortitude/activate_power()
	...
	owner.playsound_local(null, 'code/modules/antagonists/vampire/sound/fortitude_on.ogg', 100, FALSE, pressure_affected = FALSE)
	// Traits & Effects
	if(pierce)
...
/datum/action/cooldown/vampire/fortitude/deactivate_power()
	...
	owner.playsound_local(null, 'code/modules/antagonists/vampire/sound/fortitude_off.ogg', 100, FALSE, pressure_affected = FALSE)
