/datum/action/cooldown/vampire
	...
	button_icon = 'code/modules/antagonists/vampire/icons/actions_vampire.dmi'
...
/datum/action/cooldown/vampire/proc/can_use()
	...
	if((vampire_check_flags & BP_CANT_USE_WHILE_UNCONSCIOUS) && carbon_owner.stat != CONSCIOUS)
		...
		return FALSE
	// Incapacitated?
	if((vampire_check_flags & BP_CANT_USE_WHILE_INCAPACITATED) && carbon_owner.IsUnconscious())
