...
/datum/antagonist/vampire/proc/princify()
	...
	owner.current.playsound_local(null, 'code/modules/antagonists/vampire/sound/prince.ogg', 100, FALSE, pressure_affected = FALSE)
	prince = TRUE
...
/datum/antagonist/vampire/proc/scourgify()
	...
	owner.current.playsound_local(null, 'code/modules/antagonists/vampire/sound/scourge_recruit.ogg', 100, FALSE, pressure_affected = FALSE)
	scourge = TRUE
	add_team_hud(owner.current)
