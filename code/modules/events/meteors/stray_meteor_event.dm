...
/datum/round_event/stray_meteor/announce(fake)
	if(length(GLOB.meteor_list))
		...
		priority_announce("Our [sensor_name] sensors have detected an incoming signature approaching [GLOB.station_name]. Please brace for impact.", "Meteor Alert", text_ru = "Наши [sensor_name] сенсоры обнаружили приближающуюся сигнатуру по направлению к [GLOB.station_name]. Приготовьтесь к удару.", title_ru = "Тревога: метеоры")
