...
/datum/round_event/dark_matteor/announce(fake)
	priority_announce("Warning. Excessive tampering of meteor satellites has attracted a dark matt-eor. Signature approaching [GLOB.station_name]. Please brace for impact.", "Meteor Alert", 'sound/announcer/alarm/airraid.ogg', text_ru = "Внимание. Чрезмерное вмешательство в работу метеорных спутников привлекло тёмный матт-еор. Сигнатура приближается к [GLOB.station_name]. Приготовьтесь к удару.", title_ru = "Тревога: метеоры")
