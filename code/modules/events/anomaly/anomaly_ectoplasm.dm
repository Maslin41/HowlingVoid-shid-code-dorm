...
/datum/round_event/anomaly/anomaly_ectoplasm/announce(fake)
	...
	priority_announce("Paranormal ectoplasmic outburst detected on [ANOMALY_ANNOUNCE_HARMFUL_TEXT] [impact_area.name].", "Anomaly Alert", ANNOUNCER_ANOMALIES, text_ru = "Зафиксирован паранормальный эктоплазменный выброс. Локальные сканеры определили область: [impact_area.name].", title_ru = "Тревога аномалии") //NOVA EDIT CHANGE - ORIGINAL: priority_announce("Paranormal ectoplasmic outburst detected on [ANOMALY_ANNOUNCE_HARMFUL_TEXT] [impact_area.name].", "Anomaly Alert")
