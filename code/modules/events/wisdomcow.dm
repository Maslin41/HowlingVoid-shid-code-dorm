...
/datum/round_event/wisdomcow/announce(fake)
	priority_announce("A wise cow has been spotted in the area. Be sure to ask for her advice.", "Nanotrasen Cow Ranching Agency", text_ru = "В этом районе замечена мудрая корова. Не забудьте спросить у неё совета.", title_ru = "Агентство скотоводства Нанотрейзен")
