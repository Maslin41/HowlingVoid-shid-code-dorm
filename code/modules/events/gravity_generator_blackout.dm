...
/datum/round_event/gravity_generator_blackout/announce(fake)
	priority_announce("Gravnospheric anomalies detected near [station_name()]. Manual reset of generators is required.", "Anomaly Alert", ANNOUNCER_GRANOMALIES, text_ru = "Вблизи [station_name()] обнаружены гравиносферные аномалии. Требуется ручной сброс генераторов.", title_ru = "Тревога аномалии")
