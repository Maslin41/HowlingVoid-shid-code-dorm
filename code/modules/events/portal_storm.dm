...
/datum/round_event/portal_storm/announce(fake)
	...
	sleep(8 SECONDS)
	priority_announce("Massive bluespace anomaly detected en route to [station_name()]. Brace for impact.", text_ru = "К [station_name()] приближается массивная блюспейс-аномалия. Приготовьтесь к удару.")
	sleep(2 SECONDS)
