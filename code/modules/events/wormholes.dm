...
/datum/round_event/wormholes/announce(fake)
	priority_announce("Space-time anomalies detected on the station. There is no additional data.", "Anomaly Alert", ANNOUNCER_SPANOMALIES, text_ru = "На станции обнаружены пространственно-временные аномалии. Дополнительные данные отсутствуют.", title_ru = "Тревога аномалии")
