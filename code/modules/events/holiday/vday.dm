...
/datum/round_event/valentines/announce(fake)
	priority_announce("It's Valentine's Day! Give a valentine to that special someone!", text_ru = "Сегодня День святого Валентина! Подарите валентинку тому самому человеку!")
