...
/datum/shuttle_event/turbulence/activate()
	...
	minor_announce("Please note, we are entering an area of subspace turbulence. For your own safety, \
		...
		message_ru = "Обратите внимание: мы входим в зону подпространственной турбулентности. Ради вашей безопасности пристегните ремни и оставайтесь на местах до полной остановки транспорта.",
		title_ru = "Аварийный шаттл")
