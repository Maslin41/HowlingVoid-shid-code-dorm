...
/datum/station_goal/proc/send_report()
	priority_announce(
		"Priority Nanotrasen directive received. Project \"[name]\" details inbound.",
		"Incoming Priority Message",
		SSstation.announcer.get_rand_report_sound(),
		text_ru = "Получена приоритетная директива Нанотрейзен. Подробности по проекту \"[name]\" уже направлены.",
		title_ru = "Приоритетное сообщение",
	)
