/datum/quirk/poor_aim
	name = "Stormtrooper Aim(Имперский штормовик)"
	desc = "Ты ни разу в жизни не добился того, к чему стремился."
	icon = FA_ICON_BULLSEYE
	value = -4
	medical_record_text = "У пациента сильный тремор в обеих руках."
	hardcore_value = 3
