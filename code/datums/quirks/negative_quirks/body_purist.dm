/datum/quirk/body_purist
	name = "Body Purist(Поборник чистоты)"
	desc = "Ты веришь, что твоё тело — храм, а его природная форма — воплощение совершенства. Соответственно, вы презираете идею его когда-либо дополнять неестественными частями, кибернетикой, протезами или чем-то подобным."
	icon = FA_ICON_PERSON_RAYS
	value = -2
	quirk_flags = QUIRK_HUMAN_ONLY|QUIRK_MOODLET_BASED
	gain_text = span_danger("Теперь ты начинаешь ненавидеть идею наличия кибернетических имплантатов.")
	lose_text = span_notice("Может быть, кибернетика не так уж и плоха. Теперь ты спокойно относишься к аугментациям и протезам.")
	medical_record_text = "Этот пациент проявил крайнюю ненависть к неестественным частям тела и аугментациям."
	hardcore_value = 3
