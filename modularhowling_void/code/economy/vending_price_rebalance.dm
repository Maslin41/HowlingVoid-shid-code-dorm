...
// 1) Basic survival costs about one low-rank paycheck or less.
// 2) Comfort costs a few low-rank paychecks, but is trivial for mid/high earners.
// 3) Department essentials are cheap in-department and noticeable out-of-department.
// 4) Luxury hurts, but does not erase a whole starting balance unless it is premium.
// 5) Weapons and advanced equipment are expensive and limited.
// 6) Routine medicine should not bankrupt; advanced medicine should be noticeably pricier.
