...
/datum/action/cooldown/bloodsucker/targeted/tremere
	...
	button_icon = 'modularhowling_void/modules/antagonists/bloodsucker/icons/mob/actions/tremere_bloodsucker.dmi'
	background_icon = 'modularhowling_void/modules/antagonists/bloodsucker/icons/mob/actions/tremere_bloodsucker.dmi'
