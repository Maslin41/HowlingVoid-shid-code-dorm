/datum/action/cooldown/bloodsucker
	...
	background_icon = 'modularhowling_void/modules/antagonists/bloodsucker/icons/mob/actions/bloodsucker.dmi'
	background_icon_state = "vamp_power_off"
	button_icon = 'modularhowling_void/modules/antagonists/bloodsucker/icons/mob/actions/bloodsucker.dmi'
...
/datum/action/cooldown/bloodsucker/proc/can_use(mob/living/carbon/user, trigger_flags)
	...
	if((check_flags & BP_CANT_USE_WHILE_UNCONSCIOUS) && user.stat >= UNCONSCIOUS)
		...
		return FALSE
	// Incapacitated?
	if((check_flags & BP_CANT_USE_WHILE_INCAPACITATED) && (INCAPACITATED_IGNORING(user, INCAPABLE_GRAB || INCAPABLE_RESTRAINTS)))
