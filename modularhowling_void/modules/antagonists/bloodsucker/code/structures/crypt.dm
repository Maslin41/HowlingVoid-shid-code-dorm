...
/obj/structure/bloodsucker/bloodthrone
	...
	icon = 'modularhowling_void/modules/antagonists/bloodsucker/icons/obj/structures/vamp_obj_64.dmi'
	icon_state = "throne"
	buckle_lying = 0
	anchored = FALSE
	density = TRUE
...
/obj/structure/bloodsucker/bloodthrone/proc/GetArmrest()
	return mutable_appearance('modularhowling_void/modules/antagonists/bloodsucker/icons/obj/structures/vamp_obj_64.dmi', "thronearm")
...
/obj/structure/bloodsucker/bloodthrone/proc/handle_speech(datum/source, list/speech_args)
	...
	user.log_talk(message, LOG_SAY, tag = "bloodsucker")
	var/datum/antagonist/bloodsucker/bloodsuckerdatum = user.mind.has_antag_datum(/datum/antagonist/bloodsucker)
