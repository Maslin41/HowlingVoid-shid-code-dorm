/datum/antagonist/bloodsucker
	...
	hijack_speed = 0.5
	hud_icon = 'modularhowling_void/modules/bloodsucker/icons/bloodsucker_icons.dmi'
	ui_name = "AntagInfoBloodsucker"
	preview_outfit = /datum/outfit/bloodsucker_outfit
	stinger_sound = 'modularhowling_void/modules/bloodsucker/sounds/BloodsuckerAlert.ogg'
