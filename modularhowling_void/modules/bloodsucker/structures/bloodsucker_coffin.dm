...
/obj/structure/closet/crate/coffin/blackcoffin
	...
	open_sound = 'modularhowling_void/modules/bloodsucker/sounds/coffin_open.ogg'
	close_sound = 'modularhowling_void/modules/bloodsucker/sounds/coffin_close.ogg'
...
/obj/structure/closet/crate/coffin/can_open(mob/living/user)
	...
	if(user == resident)
		...
		locked = FALSE
		return TRUE
	playsound(get_turf(src), 'sound/machines/door/door_close.ogg', vol = 20, vary = TRUE)
