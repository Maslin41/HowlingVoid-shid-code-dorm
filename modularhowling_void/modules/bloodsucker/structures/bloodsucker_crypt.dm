...
/obj/structure/bloodsucker/candelabrum/attack_hand(mob/living/user, list/modifiers)
	...
	if(!.)
		return
	if(anchored && IS_BLOODSUCKER_OR_VASSAL(user))
		set_lit(!lit)
...
/obj/structure/bloodsucker/candelabrum/process()
	...
	for(var/mob/living/carbon/nearly_people in viewers(7, src))
		...
		if(IS_BLOODSUCKER_OR_VASSAL(nearly_people))
			continue
...
/obj/structure/bloodsucker/bloodthrone
	...
	icon = 'modularhowling_void/modules/bloodsucker/icons/vamp_obj_64.dmi'
	icon_state = "throne"
	buckle_lying = 0
	anchored = FALSE
	density = TRUE
...
/obj/structure/bloodsucker/bloodthrone/proc/GetArmrest()
	return mutable_appearance('modularhowling_void/modules/bloodsucker/icons/vamp_obj_64.dmi', "thronearm")
