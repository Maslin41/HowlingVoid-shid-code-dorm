...
/datum/action/cooldown/bloodsucker/targeted/mesmerize/dominate
	...
	button_icon = 'modularhowling_void/modules/bloodsucker/icons/actions_tremere_bloodsucker.dmi'
	background_icon = 'modularhowling_void/modules/bloodsucker/icons/actions_tremere_bloodsucker.dmi'
