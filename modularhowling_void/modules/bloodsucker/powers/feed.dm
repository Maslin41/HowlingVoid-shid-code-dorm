...
/datum/looping_sound/zucc
	mid_sounds = list('modularhowling_void/modules/bloodsucker/sounds/straw-slurp.ogg' = 1)
	mid_length = 1.2 SECONDS
	volume = 75
	end_volume = 100
	end_sound = 'modularhowling_void/modules/bloodsucker/sounds/straw-end.ogg'
	extra_range = 10
	ignore_walls = TRUE
