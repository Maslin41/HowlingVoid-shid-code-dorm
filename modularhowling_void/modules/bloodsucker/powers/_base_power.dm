/datum/action/cooldown/bloodsucker
	...
	background_icon = 'modularhowling_void/modules/bloodsucker/icons/actions_bloodsucker.dmi'
	background_icon_state = "vamp_power_off"
	button_icon = 'modularhowling_void/modules/bloodsucker/icons/actions_bloodsucker.dmi'
