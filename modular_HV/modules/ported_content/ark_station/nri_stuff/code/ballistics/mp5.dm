/obj/item/gun/ballistic/automatic/mp5
	...
	fire_delay = 1
	burst_size = 1
	fire_sound = 'modular_HV/modules/ported_content/ark_station/nri_stuff/sound/guns/fire/mp5_fire.ogg'
	fire_sound_volume = 100
	rack_sound = 'modular_HV/modules/ported_content/ark_station/nri_stuff/sound/guns/interact/mp5_cock.ogg'
	load_sound = 'modular_HV/modules/ported_content/ark_station/nri_stuff/sound/guns/interact/mp5_magin.ogg'
	load_empty_sound = 'modular_HV/modules/ported_content/ark_station/nri_stuff/sound/guns/interact/mp5_magin.ogg'
	eject_sound = 'modular_HV/modules/ported_content/ark_station/nri_stuff/sound/guns/interact/mp5_magout.ogg'
...
/obj/item/gun/ballistic/automatic/bison
	name = "\improper Bizon"
	desc = "A compact submachine gun of the pilots and tank crew of the Old Empire. After its collapse, the weapon's blueprints were taken by mercenaries from InteQ."
	icon = 'modular_HV/modules/ported_content/ark_station/nri_stuff/icons/guns/gunsgalore_guns.dmi'
	lefthand_file = 'modular_HV/modules/ported_content/ark_station/nri_stuff/icons/guns/gunsgalore_lefthand.dmi'
	righthand_file = 'modular_HV/modules/ported_content/ark_station/nri_stuff/icons/guns/gunsgalore_righthand.dmi'
	worn_icon = 'modular_HV/modules/ported_content/ark_station/nri_stuff/icons/guns/gunsgalore_back.dmi'
	fire_sound = 'modular_HV/modules/ported_content/ark_station/nri_stuff/sound/guns/fire/mp5_fire.ogg'
