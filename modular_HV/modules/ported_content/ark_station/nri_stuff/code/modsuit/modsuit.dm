/datum/mod_theme/frontline
	...
	variants = list(
		"frontline" = list(
			MOD_ICON_OVERRIDE = 'modular_HV/modules/ported_content/ark_station/nri_stuff/icons/modsuit/mod.dmi',
			MOD_WORN_ICON_OVERRIDE = 'modular_HV/modules/ported_content/ark_station/nri_stuff/icons/modsuit/wornmod.dmi',
			MOD_DIGITIGRADE_ICON_OVERRIDE = 'modular_HV/modules/ported_content/ark_station/nri_stuff/icons/modsuit/worn_mod_digi.dmi',
			MOD_SNOUT_ICON_OVERRIDE = 'modular_HV/modules/ported_content/ark_station/nri_stuff/icons/modsuit/worn_mod_digi.dmi',
